...
genpmodule_riscv_5stage_genmcopipe_data_mem_genstruct_fifo_wdata gen404_pipex_req_struct;
logic unsigned [31:0] gen405_pipex_mcopipe_rdata;
logic unsigned [31:0] gen406_pipex_mcopipe_rdata;
genpmodule_riscv_5stage_genmcopipe_instr_mem_genstruct_fifo_wdata gen407_pipex_req_struct;
...
always @*
	...
	genpstage_MEM_mem_addr = 32'd0;
	genpstage_MEM_mem_be = 32'd0;
	genpstage_MEM_mem_wdata = 32'd0;
	...
	gen233_cyclix_var = genpstage_WB_genctrl_stalled_glbl;
	gen0_rtl_var = gen233_cyclix_var;
	if (gen0_rtl_var)
		begin
		genpstage_WB_genctrl_new = 32'd0;
		genpstage_WB_genctrl_stalled_glbl = 32'd0;
	...
	gen1_rtl_var = gen234_cyclix_var;
	if (gen1_rtl_var)
		begin
	...
	gen235_cyclix_var = genpstage_WB_genctrl_occupied;
	gen2_rtl_var = gen235_cyclix_var;
	if (gen2_rtl_var)
		begin
		...
		gen236_cyclix_var = genpstage_WB_TRX_BUF[0].genmcopipe_handle_data_mem.rdreq_pending;
		gen3_rtl_var = gen236_cyclix_var;
		if (gen3_rtl_var)
			begin
			gen237_cyclix_var = (genpstage_WB_TRX_BUF[0].genmcopipe_handle_data_mem.if_id == 1'd0);
			gen238_cyclix_var = gen237_cyclix_var;
			gen4_rtl_var = gen238_cyclix_var;
			if (gen4_rtl_var)
				begin
				gen239_cyclix_var = (genpstage_WB_TRX_BUF[0].genmcopipe_handle_data_mem.tid == genmcopipe_data_mem_rd_ptr);
				gen240_cyclix_var = gen239_cyclix_var;
				gen5_rtl_var = gen240_cyclix_var;
				if (gen5_rtl_var)
					begin
					gen6_rtl_var = !rst_i;
					...
					gen9_rtl_var = gen242_cyclix_var;
					if (gen9_rtl_var)
						begin
		...
		gen243_cyclix_var = genpstage_WB_genpctrl_flushreq;
		gen10_rtl_var = gen243_cyclix_var;
		if (gen10_rtl_var)
			begin
			genpstage_WB_genctrl_active = 32'd0;
			end
	...
	gen244_cyclix_var = gen377_pipex_var;
	gen11_rtl_var = gen244_cyclix_var;
	if (gen11_rtl_var)
		begin
		gen378_pipex_var = ~genpstage_WB_mem_cmd;
		gen379_pipex_var = gen378_pipex_var;
		gen245_cyclix_var = gen379_pipex_var;
		gen12_rtl_var = gen245_cyclix_var;
		if (gen12_rtl_var)
			begin
			gen246_cyclix_var = genpstage_WB_TRX_BUF[0].genmcopipe_handle_data_mem.resp_done;
			gen13_rtl_var = gen246_cyclix_var;
			if (gen13_rtl_var)
				begin
			...
			gen247_cyclix_var = gen381_pipex_var;
			gen14_rtl_var = gen247_cyclix_var;
			if (gen14_rtl_var)
				begin
			...
			gen248_cyclix_var = gen382_pipex_var;
			gen15_rtl_var = gen248_cyclix_var;
			if (gen15_rtl_var)
				begin
				gen249_cyclix_var = genpstage_WB_genctrl_active;
				gen16_rtl_var = gen249_cyclix_var;
				if (gen16_rtl_var)
					begin
	...
	gen250_cyclix_var = gen384_pipex_var;
	gen17_rtl_var = gen250_cyclix_var;
	if (gen17_rtl_var)
		begin
		gen385_pipex_var = genpstage_WB_load_signext;
		gen251_cyclix_var = gen385_pipex_var;
		gen18_rtl_var = gen251_cyclix_var;
		if (gen18_rtl_var)
			begin
		...
		gen252_cyclix_var = gen389_pipex_var;
		gen19_rtl_var = gen252_cyclix_var;
		if (gen19_rtl_var)
			begin
	...
	gen253_cyclix_var = gen392_pipex_var;
	gen20_rtl_var = gen253_cyclix_var;
	if (gen20_rtl_var)
		begin
		gen393_pipex_var = genpstage_WB_load_signext;
		gen254_cyclix_var = gen393_pipex_var;
		gen21_rtl_var = gen254_cyclix_var;
		if (gen21_rtl_var)
			begin
		...
		gen255_cyclix_var = gen397_pipex_var;
		gen22_rtl_var = gen255_cyclix_var;
		if (gen22_rtl_var)
			begin
	...
	gen256_cyclix_var = gen400_pipex_var;
	gen23_rtl_var = gen256_cyclix_var;
	if (gen23_rtl_var)
		begin
		genpstage_WB_rd_wdata = genpstage_WB_mem_rdata;
		end
	gen401_pipex_var = genpstage_WB_rd_req;
	gen257_cyclix_var = gen401_pipex_var;
	gen24_rtl_var = gen257_cyclix_var;
	if (gen24_rtl_var)
		begin
		gen204_pipex_succreq = 32'd1;
		gen205_pipex_succbuf[genpstage_WB_rd_addr] = genpstage_WB_rd_wdata;
		end
	gen258_cyclix_var = genpstage_WB_genctrl_stalled_glbl;
	gen25_rtl_var = gen258_cyclix_var;
	if (gen25_rtl_var)
		begin
		genpstage_WB_genctrl_finish = 32'd0;
		genpstage_WB_genctrl_succ = 32'd0;
	...
	gen26_rtl_var = gen259_cyclix_var;
	if (gen26_rtl_var)
		begin
		genpstage_WB_genctrl_finish = genpstage_WB_genctrl_occupied;
		genpstage_WB_genctrl_succ = genpstage_WB_genctrl_active;
		end
	gen260_cyclix_var = genpstage_WB_genctrl_succ;
	gen27_rtl_var = gen260_cyclix_var;
	if (gen27_rtl_var)
		begin
		gen261_cyclix_var = gen204_pipex_succreq;
		gen28_rtl_var = gen261_cyclix_var;
		if (gen28_rtl_var)
			begin
	...
	gen262_cyclix_var = genpstage_WB_genctrl_finish;
	gen29_rtl_var = gen262_cyclix_var;
	if (gen29_rtl_var)
		begin
		gen263_cyclix_var = genpstage_WB_genctrl_succ;
		gen30_rtl_var = gen263_cyclix_var;
		if (gen30_rtl_var)
			begin
			end
		genpstage_WB_genctrl_active = 32'd0;
	...
	gen264_cyclix_var = ~genpstage_WB_TRX_BUF_COUNTER_FULL;
	genpstage_WB_genctrl_rdy = gen264_cyclix_var;
	...
	gen265_cyclix_var = genpstage_MEM_genctrl_stalled_glbl;
	gen31_rtl_var = gen265_cyclix_var;
	if (gen31_rtl_var)
		begin
		genpstage_MEM_genctrl_new = 32'd0;
		genpstage_MEM_genctrl_stalled_glbl = 32'd0;
	...
	gen266_cyclix_var = 1'd0;
	gen266_cyclix_var = (gen266_cyclix_var || gen265_cyclix_var);
	gen266_cyclix_var = !gen266_cyclix_var;
	gen32_rtl_var = gen266_cyclix_var;
	if (gen32_rtl_var)
		begin
	...
	gen267_cyclix_var = genpstage_MEM_genctrl_occupied;
	gen33_rtl_var = gen267_cyclix_var;
	if (gen33_rtl_var)
		begin
		gen268_cyclix_var = genpstage_MEM_genctrl_new;
		gen34_rtl_var = gen268_cyclix_var;
		if (gen34_rtl_var)
			begin
		...
		genpstage_MEM_jump_vector = genpstage_MEM_TRX_BUF[0].jump_vector;
		genpstage_MEM_mem_req = genpstage_MEM_TRX_BUF[0].mem_req;
		genpstage_MEM_mem_addr = genpstage_MEM_TRX_BUF[0].mem_addr;
		genpstage_MEM_mem_be = genpstage_MEM_TRX_BUF[0].mem_be;
		genpstage_MEM_mem_wdata = genpstage_MEM_TRX_BUF[0].mem_wdata;
		...
		gen269_cyclix_var = genpstage_MEM_TRX_BUF[0].genmcopipe_handle_data_mem.rdreq_pending;
		gen35_rtl_var = gen269_cyclix_var;
		if (gen35_rtl_var)
			begin
			gen270_cyclix_var = (genpstage_MEM_TRX_BUF[0].genmcopipe_handle_data_mem.if_id == 1'd0);
			gen271_cyclix_var = gen270_cyclix_var;
			gen36_rtl_var = gen271_cyclix_var;
			if (gen36_rtl_var)
				begin
				gen272_cyclix_var = (genpstage_MEM_TRX_BUF[0].genmcopipe_handle_data_mem.tid == genmcopipe_data_mem_rd_ptr);
				gen273_cyclix_var = gen272_cyclix_var;
				gen37_rtl_var = gen273_cyclix_var;
				if (gen37_rtl_var)
					begin
					gen38_rtl_var = !rst_i;
					...
					gen41_rtl_var = gen275_cyclix_var;
					if (gen41_rtl_var)
						begin
		...
		gen276_cyclix_var = genpstage_MEM_genpctrl_flushreq;
		gen42_rtl_var = gen276_cyclix_var;
		if (gen42_rtl_var)
			begin
			genpstage_MEM_genctrl_active = 32'd0;
			end
	...
	gen277_cyclix_var = gen370_pipex_var;
	gen43_rtl_var = gen277_cyclix_var;
	if (gen43_rtl_var)
		begin
	...
	gen278_cyclix_var = gen371_pipex_var;
	gen44_rtl_var = gen278_cyclix_var;
	if (gen44_rtl_var)
		begin
		gen372_pipex_var = ~genpstage_MEM_data_req_done;
		gen373_pipex_var = gen372_pipex_var;
		gen279_cyclix_var = gen373_pipex_var;
		gen45_rtl_var = gen279_cyclix_var;
		if (gen45_rtl_var)
			begin
			...
			gen46_rtl_var = gen280_cyclix_var;
			if (gen46_rtl_var)
				begin
				gen281_cyclix_var = ~genmcopipe_data_mem_full_flag;
				gen282_cyclix_var = gen281_cyclix_var;
				gen47_rtl_var = gen282_cyclix_var;
				if (gen47_rtl_var)
					begin
					gen404_pipex_req_struct.we = genpstage_MEM_mem_cmd;
					gen404_pipex_req_struct.wdata = genpstage_MEM_data_busreq;
					gen48_rtl_var = !rst_i;
					gen49_rtl_var = gen48_rtl_var;
					if (gen49_rtl_var)
						begin
						genmcopipe_data_mem_req_genfifo_req_o = 32'd1;
						gen50_rtl_var = genmcopipe_data_mem_req_genfifo_reqbuf_req;
						if (gen50_rtl_var)
							begin
							gen283_cyclix_var = 32'd0;
							end
						gen51_rtl_var = 1'd0;
						gen51_rtl_var = (gen51_rtl_var || gen50_rtl_var);
						gen51_rtl_var = !gen51_rtl_var;
						if (gen51_rtl_var)
							begin
							genmcopipe_data_mem_req_genfifo_wdata_bo = gen404_pipex_req_struct;
							gen283_cyclix_var = genmcopipe_data_mem_req_genfifo_ack_i;
							end
						genmcopipe_data_mem_req_genfifo_reqbuf_req = 32'd1;
						end
					gen284_cyclix_var = gen283_cyclix_var;
					gen52_rtl_var = gen284_cyclix_var;
					if (gen52_rtl_var)
						begin
						gen374_pipex_var = 32'd1;
						gen285_cyclix_var = !genpstage_MEM_mem_cmd;
						genpstage_MEM_TRX_BUF[0].genmcopipe_handle_data_mem.rdreq_pending = gen285_cyclix_var;
						...
						gen286_cyclix_var = genpstage_MEM_TRX_BUF[0].genmcopipe_handle_data_mem.rdreq_pending;
						gen53_rtl_var = gen286_cyclix_var;
						if (gen53_rtl_var)
							begin
			...
			gen287_cyclix_var = genpstage_MEM_genctrl_active;
			gen54_rtl_var = gen287_cyclix_var;
			if (gen54_rtl_var)
				begin
		...
		gen288_cyclix_var = gen376_pipex_var;
		gen55_rtl_var = gen288_cyclix_var;
		if (gen55_rtl_var)
			begin
			gen289_cyclix_var = genpstage_MEM_genctrl_active;
			gen56_rtl_var = gen289_cyclix_var;
			if (gen56_rtl_var)
				begin
	...
	gen290_cyclix_var = ~genpstage_WB_genctrl_rdy;
	gen291_cyclix_var = gen290_cyclix_var;
	gen57_rtl_var = gen291_cyclix_var;
	if (gen57_rtl_var)
		begin
		gen292_cyclix_var = genpstage_MEM_genctrl_active;
		gen58_rtl_var = gen292_cyclix_var;
		if (gen58_rtl_var)
			begin
			genpstage_MEM_genctrl_stalled_glbl = 32'd1;
			end
	...
	gen293_cyclix_var = genpstage_MEM_genctrl_stalled_glbl;
	gen59_rtl_var = gen293_cyclix_var;
	if (gen59_rtl_var)
		begin
		genpstage_MEM_genctrl_finish = 32'd0;
		genpstage_MEM_genctrl_succ = 32'd0;
		end
	gen294_cyclix_var = 1'd0;
	gen294_cyclix_var = (gen294_cyclix_var || gen293_cyclix_var);
	gen294_cyclix_var = !gen294_cyclix_var;
	gen60_rtl_var = gen294_cyclix_var;
	if (gen60_rtl_var)
		begin
		genpstage_MEM_genctrl_finish = genpstage_MEM_genctrl_occupied;
		genpstage_MEM_genctrl_succ = genpstage_MEM_genctrl_active;
		end
	gen295_cyclix_var = genpstage_MEM_genctrl_succ;
	gen61_rtl_var = gen295_cyclix_var;
	if (gen61_rtl_var)
		begin
		gen296_cyclix_var = gen200_pipex_succreq;
		gen62_rtl_var = gen296_cyclix_var;
		if (gen62_rtl_var)
			begin
			genpsticky_glbl_jump_req_cmd = gen201_pipex_succbuf;
			end
		gen297_cyclix_var = gen202_pipex_succreq;
		gen63_rtl_var = gen297_cyclix_var;
		if (gen63_rtl_var)
			begin
			genpsticky_glbl_jump_vector_cmd = gen203_pipex_succbuf;
			end
		end
	gen298_cyclix_var = genpstage_MEM_genctrl_finish;
	gen64_rtl_var = gen298_cyclix_var;
	if (gen64_rtl_var)
		begin
		gen299_cyclix_var = genpstage_MEM_genctrl_succ;
		gen65_rtl_var = gen299_cyclix_var;
		if (gen65_rtl_var)
			begin
			gen300_cyclix_var = genpstage_WB_genctrl_rdy;
			gen66_rtl_var = gen300_cyclix_var;
			if (gen66_rtl_var)
				begin
	...
	gen301_cyclix_var = ~genpstage_MEM_TRX_BUF_COUNTER_FULL;
	genpstage_MEM_genctrl_rdy = gen301_cyclix_var;
	...
	gen67_rtl_var = gen302_cyclix_var;
	if (gen67_rtl_var)
		begin
		genpstage_EXEC_genctrl_new = 32'd0;
		genpstage_EXEC_genctrl_stalled_glbl = 32'd0;
	...
	gen69_rtl_var = gen304_cyclix_var;
	if (gen69_rtl_var)
		begin
		gen305_cyclix_var = genpstage_EXEC_genctrl_new;
		gen70_rtl_var = gen305_cyclix_var;
		if (gen70_rtl_var)
			begin
		...
		gen306_cyclix_var = genpstage_EXEC_genpctrl_flushreq;
		gen71_rtl_var = gen306_cyclix_var;
		if (gen71_rtl_var)
			begin
			genpstage_EXEC_genctrl_active = 32'd0;
			end
	...
	gen307_cyclix_var = gen326_pipex_var;
	gen72_rtl_var = gen307_cyclix_var;
	if (gen72_rtl_var)
		begin
		gen327_pipex_var = ~genpstage_EXEC_irq_recv;
		gen328_pipex_var = gen327_pipex_var;
		gen308_cyclix_var = gen328_pipex_var;
		gen73_rtl_var = gen308_cyclix_var;
		if (gen73_rtl_var)
			begin
			gen309_cyclix_var = genpstage_EXEC_genctrl_active;
			gen74_rtl_var = gen309_cyclix_var;
			if (gen74_rtl_var)
				begin
				gen75_rtl_var = !rst_i;
				gen76_rtl_var = gen75_rtl_var;
				if (gen76_rtl_var)
					begin
					gen310_cyclix_var = 32'd0;
					gen77_rtl_var = irq_fifo_genfifo_buf_req;
					if (gen77_rtl_var)
						begin
						gen310_cyclix_var = 32'd1;
						genpstage_EXEC_irq_mcause = irq_fifo_genfifo_buf_rdata;
						irq_fifo_genfifo_buf_req = 32'd0;
						irq_fifo_genfifo_buf_ack = 32'd1;
						end
					end
				gen329_pipex_var = gen310_cyclix_var;
				end
			genpstage_EXEC_irq_recv = gen329_pipex_var;
			gen311_cyclix_var = genpstage_EXEC_genctrl_active;
			gen78_rtl_var = gen311_cyclix_var;
			if (gen78_rtl_var)
				begin
			...
			gen79_rtl_var = gen312_cyclix_var;
			if (gen79_rtl_var)
				begin
		...
		gen313_cyclix_var = gen330_pipex_var;
		gen80_rtl_var = gen313_cyclix_var;
		if (gen80_rtl_var)
			begin
	...
	gen317_cyclix_var = gen331_pipex_var;
	gen84_rtl_var = gen317_cyclix_var;
	if (gen84_rtl_var)
		begin
		gen318_cyclix_var = genpstage_EXEC_genctrl_active;
		gen85_rtl_var = gen318_cyclix_var;
		if (gen85_rtl_var)
			begin
			genpsticky_glbl_MIRQEN = 32'd1;
			end
	...
	gen319_cyclix_var = gen332_pipex_var;
	gen86_rtl_var = gen319_cyclix_var;
	if (gen86_rtl_var)
		begin
		...
		gen320_cyclix_var = gen357_pipex_var;
		gen87_rtl_var = gen320_cyclix_var;
		if (gen87_rtl_var)
			begin
		...
		gen321_cyclix_var = gen358_pipex_var;
		gen88_rtl_var = gen321_cyclix_var;
		if (gen88_rtl_var)
			begin
	...
	endcase
	gen359_pipex_var = (genpstage_EXEC_curinstr_addr + genpstage_EXEC_immediate);
	genpstage_EXEC_curinstraddr_imm = gen359_pipex_var;
	...
	endcase
	gen360_pipex_var = genpstage_EXEC_jump_req_cond;
	gen322_cyclix_var = gen360_pipex_var;
	gen89_rtl_var = gen322_cyclix_var;
	if (gen89_rtl_var)
		begin
		case (genpstage_EXEC_funct3)
			32'd0:
				begin
				gen361_pipex_var = genpstage_EXEC_alu_ZF;
				gen323_cyclix_var = gen361_pipex_var;
				gen90_rtl_var = gen323_cyclix_var;
				if (gen90_rtl_var)
					begin
					genpstage_EXEC_jump_req = 32'd1;
			...
			32'd1:
				begin
				gen362_pipex_var = ~genpstage_EXEC_alu_ZF;
				gen363_pipex_var = gen362_pipex_var;
				gen324_cyclix_var = gen363_pipex_var;
				gen91_rtl_var = gen324_cyclix_var;
				if (gen91_rtl_var)
					begin
					genpstage_EXEC_jump_req = 32'd1;
					genpstage_EXEC_jump_vector = genpstage_EXEC_curinstraddr_imm;
			...
			32'd4:
				begin
				gen364_pipex_var = genpstage_EXEC_alu_CF;
				gen325_cyclix_var = gen364_pipex_var;
				gen92_rtl_var = gen325_cyclix_var;
				if (gen92_rtl_var)
					begin
					genpstage_EXEC_jump_req = 32'd1;
					genpstage_EXEC_jump_vector = genpstage_EXEC_curinstraddr_imm;
			...
			32'd5:
				begin
				gen365_pipex_var = ~genpstage_EXEC_alu_CF;
				gen366_pipex_var = gen365_pipex_var;
				gen326_cyclix_var = gen366_pipex_var;
				gen93_rtl_var = gen326_cyclix_var;
				if (gen93_rtl_var)
					begin
					genpstage_EXEC_jump_req = 32'd1;
					genpstage_EXEC_jump_vector = genpstage_EXEC_curinstraddr_imm;
			...
			32'd6:
				begin
				gen367_pipex_var = genpstage_EXEC_alu_CF;
				gen327_cyclix_var = gen367_pipex_var;
				gen94_rtl_var = gen327_cyclix_var;
				if (gen94_rtl_var)
					begin
					genpstage_EXEC_jump_req = 32'd1;
					genpstage_EXEC_jump_vector = genpstage_EXEC_curinstraddr_imm;
			...
			32'd7:
				begin
				gen368_pipex_var = ~genpstage_EXEC_alu_CF;
				gen369_pipex_var = gen368_pipex_var;
				gen328_cyclix_var = gen369_pipex_var;
				gen95_rtl_var = gen328_cyclix_var;
				if (gen95_rtl_var)
					begin
					genpstage_EXEC_jump_req = 32'd1;
					genpstage_EXEC_jump_vector = genpstage_EXEC_curinstraddr_imm;
	...
	gen329_cyclix_var = ~genpstage_MEM_genctrl_rdy;
	gen330_cyclix_var = gen329_cyclix_var;
	gen96_rtl_var = gen330_cyclix_var;
	if (gen96_rtl_var)
		begin
		gen331_cyclix_var = genpstage_EXEC_genctrl_active;
		gen97_rtl_var = gen331_cyclix_var;
		if (gen97_rtl_var)
			begin
	...
	gen332_cyclix_var = genpstage_EXEC_genctrl_stalled_glbl;
	gen98_rtl_var = gen332_cyclix_var;
	if (gen98_rtl_var)
		begin
		genpstage_EXEC_genctrl_finish = 32'd0;
		genpstage_EXEC_genctrl_succ = 32'd0;
		end
	gen333_cyclix_var = 1'd0;
	gen333_cyclix_var = (gen333_cyclix_var || gen332_cyclix_var);
	gen333_cyclix_var = !gen333_cyclix_var;
	gen99_rtl_var = gen333_cyclix_var;
	if (gen99_rtl_var)
		begin
		genpstage_EXEC_genctrl_finish = genpstage_EXEC_genctrl_occupied;
		genpstage_EXEC_genctrl_succ = genpstage_EXEC_genctrl_active;
		end
	gen334_cyclix_var = genpstage_EXEC_genctrl_finish;
	gen100_rtl_var = gen334_cyclix_var;
	if (gen100_rtl_var)
		begin
		gen335_cyclix_var = genpstage_EXEC_genctrl_succ;
		gen101_rtl_var = gen335_cyclix_var;
		if (gen101_rtl_var)
			begin
			gen336_cyclix_var = genpstage_MEM_genctrl_rdy;
			gen102_rtl_var = gen336_cyclix_var;
			if (gen102_rtl_var)
				begin
				...
				genpstage_MEM_TRX_BUF[0].jump_vector = genpstage_EXEC_jump_vector;
				genpstage_MEM_TRX_BUF[0].mem_req = genpstage_EXEC_mem_req;
				genpstage_MEM_TRX_BUF[0].mem_addr = genpstage_EXEC_mem_addr;
				genpstage_MEM_TRX_BUF[0].mem_be = genpstage_EXEC_mem_be;
				genpstage_MEM_TRX_BUF[0].mem_wdata = genpstage_EXEC_mem_wdata;
	...
	gen338_cyclix_var = genpstage_IDECODE_genctrl_stalled_glbl;
	gen103_rtl_var = gen338_cyclix_var;
	if (gen103_rtl_var)
		begin
		genpstage_IDECODE_genctrl_new = 32'd0;
		genpstage_IDECODE_genctrl_stalled_glbl = 32'd0;
	...
	gen340_cyclix_var = genpstage_IDECODE_genctrl_occupied;
	gen105_rtl_var = gen340_cyclix_var;
	if (gen105_rtl_var)
		begin
		gen341_cyclix_var = genpstage_IDECODE_genctrl_new;
		gen106_rtl_var = gen341_cyclix_var;
		if (gen106_rtl_var)
			begin
		...
		gen342_cyclix_var = genpstage_IDECODE_TRX_BUF[0].genmcopipe_handle_instr_mem.rdreq_pending;
		gen107_rtl_var = gen342_cyclix_var;
		if (gen107_rtl_var)
			begin
			gen343_cyclix_var = (genpstage_IDECODE_TRX_BUF[0].genmcopipe_handle_instr_mem.if_id == 1'd0);
			gen344_cyclix_var = gen343_cyclix_var;
			gen108_rtl_var = gen344_cyclix_var;
			if (gen108_rtl_var)
				begin
				gen345_cyclix_var = (genpstage_IDECODE_TRX_BUF[0].genmcopipe_handle_instr_mem.tid == genmcopipe_instr_mem_rd_ptr);
				gen346_cyclix_var = gen345_cyclix_var;
				gen109_rtl_var = gen346_cyclix_var;
				if (gen109_rtl_var)
					begin
					...
					gen113_rtl_var = gen348_cyclix_var;
					if (gen113_rtl_var)
						begin
		...
		gen349_cyclix_var = genpstage_IDECODE_genpctrl_flushreq;
		gen114_rtl_var = gen349_cyclix_var;
		if (gen114_rtl_var)
			begin
			genpstage_IDECODE_genctrl_active = 32'd0;
			end
		end
	gen350_cyclix_var = genpstage_IDECODE_TRX_BUF[0].genmcopipe_handle_instr_mem.resp_done;
	gen115_rtl_var = gen350_cyclix_var;
	if (gen115_rtl_var)
		begin
	...
	gen351_cyclix_var = gen215_pipex_var;
	gen116_rtl_var = gen351_cyclix_var;
	if (gen116_rtl_var)
		begin
		gen352_cyclix_var = genpstage_IDECODE_genctrl_active;
		gen117_rtl_var = gen352_cyclix_var;
		if (gen117_rtl_var)
			begin
	...
	case (genpstage_IDECODE_opcode)
		...
		32'd99:
			...
			gen353_cyclix_var = gen232_pipex_var;
			gen118_rtl_var = gen353_cyclix_var;
			if (gen118_rtl_var)
				begin
		...
		32'd19:
			...
			case (genpstage_IDECODE_funct3)
				...
				32'd5:
					...
					gen354_cyclix_var = gen234_pipex_var;
					gen119_rtl_var = gen354_cyclix_var;
					if (gen119_rtl_var)
						begin
					...
					gen355_cyclix_var = gen235_pipex_var;
					gen120_rtl_var = gen355_cyclix_var;
					if (gen120_rtl_var)
						begin
		...
		32'd51:
			...
			case (genpstage_IDECODE_funct3)
				32'd0:
					...
					gen356_cyclix_var = gen237_pipex_var;
					gen121_rtl_var = gen356_cyclix_var;
					if (gen121_rtl_var)
						begin
						genpstage_IDECODE_alu_opcode = 32'd1;
						end
					...
					gen357_cyclix_var = gen238_pipex_var;
					gen122_rtl_var = gen357_cyclix_var;
					if (gen122_rtl_var)
						begin
						genpstage_IDECODE_alu_opcode = 32'd0;
						end
				...
				32'd5:
					...
					gen358_cyclix_var = gen239_pipex_var;
					gen123_rtl_var = gen358_cyclix_var;
					if (gen123_rtl_var)
						begin
						genpstage_IDECODE_alu_opcode = 32'd6;
						end
					...
					gen359_cyclix_var = gen240_pipex_var;
					gen124_rtl_var = gen359_cyclix_var;
					if (gen124_rtl_var)
						begin
						genpstage_IDECODE_alu_opcode = 32'd5;
						end
		...
		32'd115:
			...
			case (genpstage_IDECODE_funct3)
				32'd0:
					...
					gen360_cyclix_var = gen241_pipex_var;
					gen125_rtl_var = gen360_cyclix_var;
					if (gen125_rtl_var)
						begin
					...
					gen361_cyclix_var = gen242_pipex_var;
					gen126_rtl_var = gen361_cyclix_var;
					if (gen126_rtl_var)
						begin
	...
	gen362_cyclix_var = gen246_pipex_var;
	gen127_rtl_var = gen362_cyclix_var;
	if (gen127_rtl_var)
		begin
		case (genpstage_IDECODE_funct3)
			32'd0:
	...
	gen363_cyclix_var = gen248_pipex_var;
	gen128_rtl_var = gen363_cyclix_var;
	if (gen128_rtl_var)
		begin
	...
	gen364_cyclix_var = gen250_pipex_var;
	gen129_rtl_var = gen364_cyclix_var;
	if (gen129_rtl_var)
		begin
		genpstage_IDECODE_rd_req = 32'd0;
		end
	...
	gen365_cyclix_var = gen254_pipex_var;
	gen130_rtl_var = gen365_cyclix_var;
	if (gen130_rtl_var)
		begin
		genpstage_IDECODE_rs1_rdata = 32'd0;
		end
	...
	gen366_cyclix_var = gen256_pipex_var;
	gen131_rtl_var = gen366_cyclix_var;
	if (gen131_rtl_var)
		begin
		genpstage_IDECODE_rs2_rdata = 32'd0;
		end
	gen257_pipex_var = genpstage_IDECODE_csrreq;
	gen367_cyclix_var = gen257_pipex_var;
	gen132_rtl_var = gen367_cyclix_var;
	if (gen132_rtl_var)
		begin
	...
	gen368_cyclix_var = gen261_pipex_var;
	gen133_rtl_var = gen368_cyclix_var;
	if (gen133_rtl_var)
		begin
		gen262_pipex_var = genpstage_IDECODE_rs1_req;
		gen369_cyclix_var = gen262_pipex_var;
		gen134_rtl_var = gen369_cyclix_var;
		if (gen134_rtl_var)
			begin
			...
			gen370_cyclix_var = gen265_pipex_var;
			gen135_rtl_var = gen370_cyclix_var;
			if (gen135_rtl_var)
				begin
				gen266_pipex_var = genpstage_WB_rd_rdy;
				gen267_pipex_var = gen266_pipex_var;
				gen371_cyclix_var = gen267_pipex_var;
				gen136_rtl_var = gen371_cyclix_var;
				if (gen136_rtl_var)
					begin
					gen268_pipex_var = genpstage_WB_rd_wdata;
					genpstage_IDECODE_rs1_rdata = gen268_pipex_var;
					gen372_cyclix_var = genpstage_IDECODE_genctrl_active;
					gen137_rtl_var = gen372_cyclix_var;
					if (gen137_rtl_var)
						begin
				...
				gen373_cyclix_var = gen269_pipex_var;
				gen138_rtl_var = gen373_cyclix_var;
				if (gen138_rtl_var)
					begin
					gen374_cyclix_var = genpstage_IDECODE_genctrl_active;
					gen139_rtl_var = gen374_cyclix_var;
					if (gen139_rtl_var)
						begin
						genpstage_IDECODE_genctrl_stalled_glbl = 32'd1;
						end
		...
		gen375_cyclix_var = gen270_pipex_var;
		gen140_rtl_var = gen375_cyclix_var;
		if (gen140_rtl_var)
			begin
			...
			gen376_cyclix_var = gen273_pipex_var;
			gen141_rtl_var = gen376_cyclix_var;
			if (gen141_rtl_var)
				begin
				gen274_pipex_var = genpstage_WB_rd_rdy;
				gen275_pipex_var = gen274_pipex_var;
				gen377_cyclix_var = gen275_pipex_var;
				gen142_rtl_var = gen377_cyclix_var;
				if (gen142_rtl_var)
					begin
					gen276_pipex_var = genpstage_WB_rd_wdata;
					genpstage_IDECODE_rs2_rdata = gen276_pipex_var;
					gen378_cyclix_var = genpstage_IDECODE_genctrl_active;
					gen143_rtl_var = gen378_cyclix_var;
					if (gen143_rtl_var)
						begin
				...
				gen379_cyclix_var = gen277_pipex_var;
				gen144_rtl_var = gen379_cyclix_var;
				if (gen144_rtl_var)
					begin
					gen380_cyclix_var = genpstage_IDECODE_genctrl_active;
					gen145_rtl_var = gen380_cyclix_var;
					if (gen145_rtl_var)
						begin
						genpstage_IDECODE_genctrl_stalled_glbl = 32'd1;
						end
	...
	gen381_cyclix_var = gen281_pipex_var;
	gen146_rtl_var = gen381_cyclix_var;
	if (gen146_rtl_var)
		begin
		gen282_pipex_var = genpstage_IDECODE_rs1_req;
		gen382_cyclix_var = gen282_pipex_var;
		gen147_rtl_var = gen382_cyclix_var;
		if (gen147_rtl_var)
			begin
			...
			gen383_cyclix_var = gen285_pipex_var;
			gen148_rtl_var = gen383_cyclix_var;
			if (gen148_rtl_var)
				begin
				gen286_pipex_var = genpstage_MEM_rd_rdy;
				gen287_pipex_var = gen286_pipex_var;
				gen384_cyclix_var = gen287_pipex_var;
				gen149_rtl_var = gen384_cyclix_var;
				if (gen149_rtl_var)
					begin
					...
					gen150_rtl_var = gen385_cyclix_var;
					if (gen150_rtl_var)
						begin
				...
				gen386_cyclix_var = gen289_pipex_var;
				gen151_rtl_var = gen386_cyclix_var;
				if (gen151_rtl_var)
					begin
					gen387_cyclix_var = genpstage_IDECODE_genctrl_active;
					gen152_rtl_var = gen387_cyclix_var;
					if (gen152_rtl_var)
						begin
						genpstage_IDECODE_genctrl_stalled_glbl = 32'd1;
						end
		...
		gen388_cyclix_var = gen290_pipex_var;
		gen153_rtl_var = gen388_cyclix_var;
		if (gen153_rtl_var)
			begin
			...
			gen389_cyclix_var = gen293_pipex_var;
			gen154_rtl_var = gen389_cyclix_var;
			if (gen154_rtl_var)
				begin
				gen294_pipex_var = genpstage_MEM_rd_rdy;
				gen295_pipex_var = gen294_pipex_var;
				gen390_cyclix_var = gen295_pipex_var;
				gen155_rtl_var = gen390_cyclix_var;
				if (gen155_rtl_var)
					begin
					...
					gen156_rtl_var = gen391_cyclix_var;
					if (gen156_rtl_var)
						begin
				...
				gen392_cyclix_var = gen297_pipex_var;
				gen157_rtl_var = gen392_cyclix_var;
				if (gen157_rtl_var)
					begin
					gen393_cyclix_var = genpstage_IDECODE_genctrl_active;
					gen158_rtl_var = gen393_cyclix_var;
					if (gen158_rtl_var)
						begin
						genpstage_IDECODE_genctrl_stalled_glbl = 32'd1;
						end
	...
	gen394_cyclix_var = gen301_pipex_var;
	gen159_rtl_var = gen394_cyclix_var;
	if (gen159_rtl_var)
		begin
		gen302_pipex_var = genpstage_IDECODE_rs1_req;
		gen395_cyclix_var = gen302_pipex_var;
		gen160_rtl_var = gen395_cyclix_var;
		if (gen160_rtl_var)
			begin
			...
			gen396_cyclix_var = gen305_pipex_var;
			gen161_rtl_var = gen396_cyclix_var;
			if (gen161_rtl_var)
				begin
				gen306_pipex_var = genpstage_EXEC_rd_rdy;
				gen307_pipex_var = gen306_pipex_var;
				gen397_cyclix_var = gen307_pipex_var;
				gen162_rtl_var = gen397_cyclix_var;
				if (gen162_rtl_var)
					begin
					...
					gen163_rtl_var = gen398_cyclix_var;
					if (gen163_rtl_var)
						begin
				...
				gen399_cyclix_var = gen309_pipex_var;
				gen164_rtl_var = gen399_cyclix_var;
				if (gen164_rtl_var)
					begin
					gen400_cyclix_var = genpstage_IDECODE_genctrl_active;
					gen165_rtl_var = gen400_cyclix_var;
					if (gen165_rtl_var)
						begin
						genpstage_IDECODE_genctrl_stalled_glbl = 32'd1;
						end
		...
		gen401_cyclix_var = gen310_pipex_var;
		gen166_rtl_var = gen401_cyclix_var;
		if (gen166_rtl_var)
			begin
			...
			gen402_cyclix_var = gen313_pipex_var;
			gen167_rtl_var = gen402_cyclix_var;
			if (gen167_rtl_var)
				begin
				gen314_pipex_var = genpstage_EXEC_rd_rdy;
				gen315_pipex_var = gen314_pipex_var;
				gen403_cyclix_var = gen315_pipex_var;
				gen168_rtl_var = gen403_cyclix_var;
				if (gen168_rtl_var)
					begin
					...
					gen169_rtl_var = gen404_cyclix_var;
					if (gen169_rtl_var)
						begin
				...
				gen405_cyclix_var = gen317_pipex_var;
				gen170_rtl_var = gen405_cyclix_var;
				if (gen170_rtl_var)
					begin
					gen406_cyclix_var = genpstage_IDECODE_genctrl_active;
					gen171_rtl_var = gen406_cyclix_var;
					if (gen171_rtl_var)
						begin
						genpstage_IDECODE_genctrl_stalled_glbl = 32'd1;
						end
	...
	gen407_cyclix_var = gen318_pipex_var;
	gen172_rtl_var = gen407_cyclix_var;
	if (gen172_rtl_var)
		begin
	...
	gen408_cyclix_var = gen321_pipex_var;
	gen173_rtl_var = gen408_cyclix_var;
	if (gen173_rtl_var)
		begin
	...
	gen409_cyclix_var = ~genpstage_EXEC_genctrl_rdy;
	gen410_cyclix_var = gen409_cyclix_var;
	gen174_rtl_var = gen410_cyclix_var;
	if (gen174_rtl_var)
		begin
		gen411_cyclix_var = genpstage_IDECODE_genctrl_active;
		gen175_rtl_var = gen411_cyclix_var;
		if (gen175_rtl_var)
			begin
			genpstage_IDECODE_genctrl_stalled_glbl = 32'd1;
			end
	...
	gen412_cyclix_var = genpstage_IDECODE_genctrl_stalled_glbl;
	gen176_rtl_var = gen412_cyclix_var;
	if (gen176_rtl_var)
		begin
		genpstage_IDECODE_genctrl_finish = 32'd0;
		genpstage_IDECODE_genctrl_succ = 32'd0;
		end
	gen413_cyclix_var = 1'd0;
	gen413_cyclix_var = (gen413_cyclix_var || gen412_cyclix_var);
	gen413_cyclix_var = !gen413_cyclix_var;
	gen177_rtl_var = gen413_cyclix_var;
	if (gen177_rtl_var)
		begin
	...
	gen414_cyclix_var = genpstage_IDECODE_genctrl_finish;
	gen178_rtl_var = gen414_cyclix_var;
	if (gen178_rtl_var)
		begin
		gen415_cyclix_var = genpstage_IDECODE_genctrl_succ;
		gen179_rtl_var = gen415_cyclix_var;
		if (gen179_rtl_var)
			begin
			gen416_cyclix_var = genpstage_EXEC_genctrl_rdy;
			gen180_rtl_var = gen416_cyclix_var;
			if (gen180_rtl_var)
				begin
	...
	gen417_cyclix_var = ~genpstage_IDECODE_TRX_BUF_COUNTER_FULL;
	genpstage_IDECODE_genctrl_rdy = gen417_cyclix_var;
	...
	gen418_cyclix_var = genpstage_IFETCH_genctrl_stalled_glbl;
	gen181_rtl_var = gen418_cyclix_var;
	if (gen181_rtl_var)
		begin
		genpstage_IFETCH_genctrl_new = 32'd0;
		genpstage_IFETCH_genctrl_stalled_glbl = 32'd0;
	...
	gen419_cyclix_var = 1'd0;
	gen419_cyclix_var = (gen419_cyclix_var || gen418_cyclix_var);
	gen419_cyclix_var = !gen419_cyclix_var;
	gen182_rtl_var = gen419_cyclix_var;
	if (gen182_rtl_var)
		begin
		genpstage_IFETCH_genctrl_active = 32'd1;
	...
	gen420_cyclix_var = genpstage_IFETCH_genctrl_occupied;
	gen183_rtl_var = gen420_cyclix_var;
	if (gen183_rtl_var)
		begin
		gen421_cyclix_var = genpstage_IFETCH_genctrl_new;
		gen184_rtl_var = gen421_cyclix_var;
		if (gen184_rtl_var)
			begin
			genpstage_IFETCH_TRX_BUF[0].instr_req_done = 32'd0;
			end
		genpstage_IFETCH_instr_req_done = genpstage_IFETCH_TRX_BUF[0].instr_req_done;
		gen422_cyclix_var = genpstage_IFETCH_TRX_BUF[0].genmcopipe_handle_instr_mem.rdreq_pending;
		gen185_rtl_var = gen422_cyclix_var;
		if (gen185_rtl_var)
			begin
			gen423_cyclix_var = (genpstage_IFETCH_TRX_BUF[0].genmcopipe_handle_instr_mem.if_id == 1'd0);
			gen424_cyclix_var = gen423_cyclix_var;
			gen186_rtl_var = gen424_cyclix_var;
			if (gen186_rtl_var)
				begin
				gen425_cyclix_var = (genpstage_IFETCH_TRX_BUF[0].genmcopipe_handle_instr_mem.tid == genmcopipe_instr_mem_rd_ptr);
				gen426_cyclix_var = gen425_cyclix_var;
				gen187_rtl_var = gen426_cyclix_var;
				if (gen187_rtl_var)
					begin
					...
					gen191_rtl_var = gen428_cyclix_var;
					if (gen191_rtl_var)
						begin
		...
		gen429_cyclix_var = genpstage_IFETCH_genpctrl_flushreq;
		gen192_rtl_var = gen429_cyclix_var;
		if (gen192_rtl_var)
			begin
			end
		end
	...
	gen430_cyclix_var = gen206_pipex_var;
	gen193_rtl_var = gen430_cyclix_var;
	if (gen193_rtl_var)
		begin
	...
	gen207_pipex_var = (genpstage_IFETCH_curinstr_addr + 32'd4);
	genpstage_IFETCH_nextinstr_addr = gen207_pipex_var;
	gen198_pipex_succreq = 32'd1;
	gen199_pipex_succbuf = genpstage_IFETCH_nextinstr_addr;
	...
	gen431_cyclix_var = gen209_pipex_var;
	gen194_rtl_var = gen431_cyclix_var;
	if (gen194_rtl_var)
		begin
		gen432_cyclix_var = genpstage_IFETCH_genctrl_active;
		gen195_rtl_var = gen432_cyclix_var;
		if (gen195_rtl_var)
			begin
			gen433_cyclix_var = ~genmcopipe_instr_mem_full_flag;
			gen434_cyclix_var = gen433_cyclix_var;
			gen196_rtl_var = gen434_cyclix_var;
			if (gen196_rtl_var)
				begin
				gen407_pipex_req_struct.we = 1'd0;
				gen407_pipex_req_struct.wdata = genpstage_IFETCH_instr_busreq;
				gen197_rtl_var = !rst_i;
				gen198_rtl_var = gen197_rtl_var;
				if (gen198_rtl_var)
					begin
					genmcopipe_instr_mem_req_genfifo_req_o = 32'd1;
					gen199_rtl_var = genmcopipe_instr_mem_req_genfifo_reqbuf_req;
					if (gen199_rtl_var)
						begin
						gen435_cyclix_var = 32'd0;
						end
					gen200_rtl_var = 1'd0;
					gen200_rtl_var = (gen200_rtl_var || gen199_rtl_var);
					gen200_rtl_var = !gen200_rtl_var;
					if (gen200_rtl_var)
						begin
						genmcopipe_instr_mem_req_genfifo_wdata_bo = gen407_pipex_req_struct;
						gen435_cyclix_var = genmcopipe_instr_mem_req_genfifo_ack_i;
						end
					genmcopipe_instr_mem_req_genfifo_reqbuf_req = 32'd1;
					end
				gen436_cyclix_var = gen435_cyclix_var;
				gen201_rtl_var = gen436_cyclix_var;
				if (gen201_rtl_var)
					begin
					gen210_pipex_var = 32'd1;
					gen437_cyclix_var = !1'd0;
					genpstage_IFETCH_TRX_BUF[0].genmcopipe_handle_instr_mem.rdreq_pending = gen437_cyclix_var;
					...
					gen438_cyclix_var = genpstage_IFETCH_TRX_BUF[0].genmcopipe_handle_instr_mem.rdreq_pending;
					gen202_rtl_var = gen438_cyclix_var;
					if (gen202_rtl_var)
						begin
		...
		gen203_rtl_var = gen439_cyclix_var;
		if (gen203_rtl_var)
			begin
	...
	gen440_cyclix_var = gen212_pipex_var;
	gen204_rtl_var = gen440_cyclix_var;
	if (gen204_rtl_var)
		begin
		gen441_cyclix_var = genpstage_IFETCH_genctrl_active;
		gen205_rtl_var = gen441_cyclix_var;
		if (gen205_rtl_var)
			begin
	...
	gen442_cyclix_var = ~genpstage_IDECODE_genctrl_rdy;
	gen443_cyclix_var = gen442_cyclix_var;
	gen206_rtl_var = gen443_cyclix_var;
	if (gen206_rtl_var)
		begin
		gen444_cyclix_var = genpstage_IFETCH_genctrl_active;
		gen207_rtl_var = gen444_cyclix_var;
		if (gen207_rtl_var)
			begin
			genpstage_IFETCH_genctrl_stalled_glbl = 32'd1;
			end
	...
	gen445_cyclix_var = genpstage_IFETCH_genctrl_stalled_glbl;
	gen208_rtl_var = gen445_cyclix_var;
	if (gen208_rtl_var)
		begin
		genpstage_IFETCH_genctrl_finish = 32'd0;
		genpstage_IFETCH_genctrl_succ = 32'd0;
	...
	gen446_cyclix_var = (gen446_cyclix_var || gen445_cyclix_var);
	gen446_cyclix_var = !gen446_cyclix_var;
	gen209_rtl_var = gen446_cyclix_var;
	if (gen209_rtl_var)
		begin
	...
	gen210_rtl_var = gen447_cyclix_var;
	if (gen210_rtl_var)
		begin
		gen448_cyclix_var = gen196_pipex_succreq;
		gen211_rtl_var = gen448_cyclix_var;
		if (gen211_rtl_var)
			begin
			genpsticky_glbl_jump_req_cmd = gen197_pipex_succbuf;
			end
		gen449_cyclix_var = gen198_pipex_succreq;
		gen212_rtl_var = gen449_cyclix_var;
		if (gen212_rtl_var)
			begin
			genpsticky_glbl_pc = gen199_pipex_succbuf;
			end
		end
	gen450_cyclix_var = genpstage_IFETCH_genctrl_finish;
	gen213_rtl_var = gen450_cyclix_var;
	if (gen213_rtl_var)
		begin
		gen451_cyclix_var = genpstage_IFETCH_genctrl_succ;
		gen214_rtl_var = gen451_cyclix_var;
		if (gen214_rtl_var)
			begin
			gen452_cyclix_var = genpstage_IDECODE_genctrl_rdy;
			gen215_rtl_var = gen452_cyclix_var;
			if (gen215_rtl_var)
				begin
	...
	gen453_cyclix_var = ~genpstage_IFETCH_TRX_BUF_COUNTER_FULL;
	genpstage_IFETCH_genctrl_rdy = gen453_cyclix_var;
	genpstage_IFETCH_genctrl_working = (genpstage_IFETCH_genctrl_succ | genpstage_IFETCH_genctrl_stalled_glbl);
	gen454_cyclix_var = genmcopipe_instr_mem_rd_done;
	gen216_rtl_var = gen454_cyclix_var;
	if (gen216_rtl_var)
		begin
		genmcopipe_instr_mem_rd_ptr = genmcopipe_instr_mem_rd_ptr_next;
		genmcopipe_instr_mem_full_flag = 32'd0;
		gen455_cyclix_var = (genmcopipe_instr_mem_rd_ptr == genmcopipe_instr_mem_wr_ptr);
		gen456_cyclix_var = gen455_cyclix_var;
		gen217_rtl_var = gen456_cyclix_var;
		if (gen217_rtl_var)
			begin
			genmcopipe_instr_mem_empty_flag = 32'd1;
			end
		end
	gen457_cyclix_var = genmcopipe_instr_mem_wr_done;
	gen218_rtl_var = gen457_cyclix_var;
	if (gen218_rtl_var)
		begin
		genmcopipe_instr_mem_wr_ptr = genmcopipe_instr_mem_wr_ptr_next;
		genmcopipe_instr_mem_empty_flag = 32'd0;
		gen458_cyclix_var = (genmcopipe_instr_mem_rd_ptr == genmcopipe_instr_mem_wr_ptr);
		gen459_cyclix_var = gen458_cyclix_var;
		gen219_rtl_var = gen459_cyclix_var;
		if (gen219_rtl_var)
			begin
			genmcopipe_instr_mem_full_flag = 32'd1;
			end
		end
	gen460_cyclix_var = genmcopipe_data_mem_rd_done;
	gen220_rtl_var = gen460_cyclix_var;
	if (gen220_rtl_var)
		begin
		genmcopipe_data_mem_rd_ptr = genmcopipe_data_mem_rd_ptr_next;
		genmcopipe_data_mem_full_flag = 32'd0;
		gen461_cyclix_var = (genmcopipe_data_mem_rd_ptr == genmcopipe_data_mem_wr_ptr);
		gen462_cyclix_var = gen461_cyclix_var;
		gen221_rtl_var = gen462_cyclix_var;
		if (gen221_rtl_var)
			begin
			genmcopipe_data_mem_empty_flag = 32'd1;
			end
		end
	gen463_cyclix_var = genmcopipe_data_mem_wr_done;
	gen222_rtl_var = gen463_cyclix_var;
	if (gen222_rtl_var)
		begin
		genmcopipe_data_mem_wr_ptr = genmcopipe_data_mem_wr_ptr_next;
		genmcopipe_data_mem_empty_flag = 32'd0;
		gen464_cyclix_var = (genmcopipe_data_mem_rd_ptr == genmcopipe_data_mem_wr_ptr);
		gen465_cyclix_var = gen464_cyclix_var;
		gen223_rtl_var = gen465_cyclix_var;
		if (gen223_rtl_var)
			begin
