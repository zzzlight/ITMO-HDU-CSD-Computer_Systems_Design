...
REM
REM Generated by Vivado on Fri Jun 18 21:31:13 +0800 2021
...
echo "xvlog --incr --relax -L uvm -prj riscv_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj riscv_tb_vlog.prj -log xvlog.log
